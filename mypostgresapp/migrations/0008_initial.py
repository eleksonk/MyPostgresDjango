# Generated by Django 4.0.2 on 2022-03-08 13:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mypostgresapp', '0007_delete_vm_vh_class'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vh_class', models.IntegerField()),
                ('fk_vh_class', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='mypostgresapp.vm_vh_class')),
            ],
        ),
    ]
